...
// About this code : MergeSort Tree without updates, precomputed prefix minimums
// for all segtree[u] vectors to query min( second value in pair, which is
