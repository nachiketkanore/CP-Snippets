...
struct MinCostMaxFlow         // This takes a value K and for all possible ways for flows = K it will return the minimum cost.
{
    int nodes;
    ...
    void addEdge(int source, int to, int capacity, int cost)        // While adding edge we have to mention (src,dest,cap,cost);
    {
