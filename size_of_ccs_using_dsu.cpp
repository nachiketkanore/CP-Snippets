// With reference to the problem on HackerEarth :
// https://www.hackerearth.com/practice/data-structures/disjoint-data-strutures/basics-of-disjoint-data-structures/practice-problems/algorithm/ikshu-and-his-class-1/
...
int32_t main() {
  ...
  while (k--) {
    ...
    int u, v;
    cin >> u >> v; // nodes were 0 indexed , so needed to increment
    u++, v++;
    dsu.unite(u, v);
  }
